...
var FormateTime = function FormateTime(arg) {
  ...
  var getWeek = function getWeek(num) {
    if (Object.prototype.toString.call(num) !== "[object Number]") {
  ...
  var _ref = [String(O.getFullYear()), doubleDigit(O.getMonth() + 1), doubleDigit(O.getDate()), "\u661F\u671F".concat(getWeek(O.getDay())), doubleDigit(O.getHours()), doubleDigit(O.getMinutes()), doubleDigit(O.getSeconds())],
      Y = _ref[0],
      M = _ref[1],
      D = _ref[2],
      w = _ref[3],
...
var DeepCopyRA = function DeepCopyRA(arg) {
  ...
  if (isType("Object", arg) || isType("Array", arg)) {
    ...
    for (var key in arg) {
      // 防止原型链的值
      Object.prototype.hasOwnProperty.call(arg, key) && (newValue[key] = DeepCopy(arg[key]));
    }
  }
...
/* harmony default export */ var MeAPI_function = ({
  ...
  IsType: IsType,
  // 变量类型判断
  DeepCopyRA: DeepCopyRA // 深拷贝变量-递归算法(recursive algorithm)
