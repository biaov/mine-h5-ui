import { ref, defineComponent, openBlock, createElementBlock, Fragment, createCommentVNode, createVNode, Transition, withCtx, createElementVNode, renderList, withModifiers, normalizeStyle, toDisplayString } from 'vue';
...
script.__file = "packages/MeAddressPicker/index.vue";

script.install = (app) => {
    app.component(script.name, script);
};
const InMeAddressPicker = script;

export { InMeAddressPicker as default };
