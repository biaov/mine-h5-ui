import { ref, onMounted, onUnmounted, defineComponent, openBlock, createElementBlock, Fragment, createCommentVNode, createElementVNode, withDirectives, normalizeStyle, toDisplayString, vShow, renderList, normalizeClass } from 'vue';
...
const _hoisted_1 = { class: "me-index-bar" };
const _hoisted_2 = { class: "m-list-rt" };
const _hoisted_3 = {
  class: "m-list-cont",
  ref: "listCont"
};
const _hoisted_4 = { class: "m-list-item" };
...
script.__file = "packages/MeIndexBar/index.vue";

script.install = (app) => {
    app.component(script.name, script);
};
const InMeIndexBar = script;

export { InMeIndexBar as default };
