<template>
  ...
  <ul class="m-button">
    <li v-for="item in listData" :key="item.id">
      ...
      <me-button v-for="it in item.btns" :key="it.id" :type="it.type" :plain="!!it.plain" :disabled="!!it.disabled" :color="!it.color ? '' : it.color" :icon="!it.icon ? '' : it.icon" @on-click="handleBtn(it)">
        {{ it.value }}
      </me-button>
    </li>
  </ul>
